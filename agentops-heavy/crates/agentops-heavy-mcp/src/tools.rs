...
//! configured — no license/advisor-mode distinction, since semantic search
//! has no write-capable variant to restrict in the first place, and 1.0 has
//! no payment gate at all.
