...
//! counts, no per-stage error field, and lives in the light-tier (open-core)
//! workspace while `RepoConnection` is heavy-tier (commercial). This is a
//! separate, purpose-built table for a polled progress bar, not a reuse of
//! that subsystem.
//!
