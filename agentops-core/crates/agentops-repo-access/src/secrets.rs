...
//! deployment's process environment, so anyone who can read the
...
//! requirement before this is used for a real multi-tenant hosted
//! deployment; that implementation isn't written yet (see SECURITY.md).
